...
with DAG(
    dag_id="gold_legacy_pipeline_v2",
    schedule=None,
    ...
    def create_tables():
        ...
        sql1 = """
        CREATE TABLE fifa23_gold.general_info_players_legacy (
            ...
            club_team_id BIGINT CHECK (club_team_id > 0 OR club_team_id IS NULL),
            ...
            nation_team_id BIGINT CHECK (nation_team_id > 0 OR nation_team_id IS NULL),
            ...
            CONSTRAINT fk_general_legacy_nationality
        ...
        sql2 = """
        CREATE TABLE fifa23_gold.players_market_val_legacy (
            player_id BIGINT NOT NULL CHECK (player_id > 0),
            fifa_version INT NOT NULL CHECK (fifa_version BETWEEN 6 AND 30),
            ...
            international_reputation INT CHECK (
                international_reputation BETWEEN 1 AND 5
                OR international_reputation IS NULL
            ),

            release_clause_eur BIGINT CHECK (
        ...
        sql3 = """
        CREATE TABLE fifa23_gold.players_physics_legacy (
            player_id BIGINT NOT NULL CHECK (player_id > 0),
            fifa_version INT NOT NULL CHECK (fifa_version BETWEEN 6 AND 30),
            short_name VARCHAR(100) NOT NULL,
        ...
        sql4 = """
        CREATE TABLE fifa23_gold.players_club_legacy (
            player_id BIGINT NOT NULL CHECK (player_id > 0),
            fifa_version INT NOT NULL CHECK (fifa_version BETWEEN 6 AND 30),
            short_name VARCHAR(100) NOT NULL,

            club_team_id BIGINT CHECK (
                club_team_id > 0
            ...
            CONSTRAINT fk_players_legacy_club_league
        ...
        sql5 = """
        CREATE VIEW fifa23_silver.latest_fifa23_legacy AS
        SELECT *
        FROM (
            SELECT
                *,
        ...
        with engine.begin() as conn:
            conn.execute(text("""DROP VIEW IF EXISTS fifa23_silver.latest_fifa23_legacy;"""))
            conn.execute(text("""DROP TABLE IF EXISTS fifa23_gold.general_info_players_legacy CASCADE;"""))
            conn.execute(text("""DROP TABLE IF EXISTS fifa23_gold.players_market_val_legacy CASCADE;"""))
            conn.execute(text("""DROP TABLE IF EXISTS fifa23_gold.players_physics_legacy CASCADE;"""))
            conn.execute(text("""DROP TABLE IF EXISTS fifa23_gold.players_club_legacy CASCADE;"""))
    ...
    def insert_into_general_legacy():
        ...
        sql = """
        INSERT INTO fifa23_gold.general_info_players_legacy (
            player_id,
            fifa_version,
            player_url,
            age,
        ...
        SELECT
            ...
            nation_jersey_number,
            player_face_url
        FROM fifa23_silver.latest_fifa23_legacy
    ...
    def insert_players_market_val_legacy():
        ...
        sql = """
        INSERT INTO fifa23_gold.players_market_val_legacy (
            player_id,
            fifa_version,
            short_name,
            overall,
        ...
        SELECT
            ...
            club_team_id,
            TRIM(club_name),
            TO_DATE(NULLIF(TRIM(club_joined_date), ''), 'YYYY-MM-DD'),
            club_contract_valid_until_year,
            TRIM(league_name),
            TRIM(nationality_name),
            international_reputation,
    ...
    def insert_players_physics_legacy():
        ...
        sql = """
        INSERT INTO fifa23_gold.players_physics_legacy (
            player_id,
            fifa_version,
            short_name,
            age,
    ...
    def insert_players_club_legacy():
        ...
        sql = """
        INSERT INTO fifa23_gold.players_club_legacy (
            player_id,
            fifa_version,
            short_name,
            club_team_id,
