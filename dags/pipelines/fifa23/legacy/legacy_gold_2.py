...
with DAG(
    ...
    def create_tables_2():
        ...
        sql4 = """
            ...
            body_type VARCHAR(50),
            real_face VARCHAR(3) CHECK (real_face IN ('No','Yes') OR real_face IS NULL),
        ...
        """
        sql6 = """
        CREATE VIEW latest_fifa23_legacy_2 AS
        SELECT *
        FROM (
            SELECT
                *,
        ...
        with engine.begin() as conn:
            conn.execute(text("""DROP VIEW IF EXISTS latest_fifa23_legacy_2;"""))
