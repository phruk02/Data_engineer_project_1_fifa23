...
with DAG(
    dag_id="cleaned_male_coaches",
    schedule=None,
    start_date=datetime(2026, 6, 6),
    catchup=False,
    tags=["fifa23", "clean", "coaches"],
) as dag:
    ...
    def clean_coaches():
        ...
        sql = """
        DROP TABLE IF EXISTS cleaned_male_coaches CASCADE;

        CREATE TABLE cleaned_male_coaches (
        ...
        INSERT INTO cleaned_male_coaches (
            coach_id,
            coach_url,
            short_name,
            long_name,
