...
with DAG(
    dag_id="first_clean_team_v2",
    schedule=None,
    start_date=datetime(2026, 6, 6),
    catchup=False,
    tags=["fifa23", "silver", "team","v2"],
) as dag:
    ...
    def create_silver_team():
        ...
        CREATE TABLE fifa23_silver.silver_male_teams (
        ...
        INSERT INTO fifa23_silver.silver_male_teams
        SELECT
            team_id,
            team_url,
            fifa_version,
        ...
        with engine.begin() as conn:
            conn.execute(text("""DROP TABLE IF EXISTS fifa23_silver.silver_male_teams CASCADE;"""))
